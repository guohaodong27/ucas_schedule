...
# 果壳教学楼信息
UCAS_GEO = {
    '教一楼': Geo("教学楼1", 30.748903, 103.931567),
    '教二楼': Geo("教学楼2", 30.748903, 103.931567),
    '雁栖湖东区礼堂': Geo("教学楼2", 30.748903, 103.931567),
}


def format_course_period(s: str) -> list:
    # 前半部分是星期几
    s = s.split('：')
    # 切片，到数字，分割，确定第几节课
...
def get_course_teacher(url: str) -> str:
...
def add_course(urls) -> list[Course]:
    courses = []
